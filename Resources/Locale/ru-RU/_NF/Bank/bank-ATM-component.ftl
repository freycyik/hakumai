...
bank-atm-menu-deposit-label = Внести:{ " " }
...
vending-machine-menu-cash-slot-label = Купюроприёмник:{ " " }
...
station-bank-requires-reason = NT требует указать детали транзакции
station-bank-unauthorized = Отказано в доступе!
bank-atm-menu-cash-error = ОШИБКА: НЕВАЛИДНО
