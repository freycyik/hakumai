...
ent-ClothingHeadHatBeretSecurity = classic security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety. A true classic.
ent-ClothingHeadHatBeretSecurityBlack = black security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety.
ent-ClothingHeadHatBeretSecurityDarkBlue = dark blue security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety.
ent-ClothingHeadHatBeretSecurityDarkRed = dark red security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety.
ent-ClothingHeadHatBeretSecurityLightBlue = light blue security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety.
ent-ClothingHeadHatBeretSecurityLightRed = light red security beret
    .desc = A beret with the security department's insignia. For officers that are more inclined towards style than safety.
