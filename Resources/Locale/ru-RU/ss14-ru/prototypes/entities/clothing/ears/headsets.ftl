ent-ClothingHeadset = headset
    .desc = An updated, modular intercom that fits over the head. Channel access is determined by the faction you target.
ent-ClothingHeadsetGrey = general headset
