...
ent-GasRecycler = gas recycler
    .desc = Recycles waste gases into useful gases. Can hold a beaker to collect reagents skimmed from the gas stream. Requires high temperature and pressure to operate.
