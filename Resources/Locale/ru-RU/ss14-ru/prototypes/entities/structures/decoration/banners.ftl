...
ent-BannerSolarLegion = solar legion banner
    .desc = A banner displaying the Solar Legion logo. Spear tip blunted for safety.
ent-BannerWayfarerDynamics = wayfarer dynamics banner
    .desc = A banner displaying the Wayfarer Dynamics logo. Honors the great solar panel bridges of Exodus Station.
