...
ent-MethaneCanister = methane canister
    .desc = A canister filled with methane. It can be attached to connector ports using a wrench.
ent-HydrogenCanister = hydrogen canister
    .desc = A canister filled with hydrogen. It can be attached to connector ports using a wrench.
ent-FluorineCanister = fluorine canister
    .desc = A canister filled with fluorine. It can be attached to connector ports using a wrench.
ent-ChlorineCanister = chlorine canister
    .desc = A canister filled with chlorine. It can be attached to connector ports using a wrench.
ent-ChlorineTrifluorideCanister = chlorine trifluoride canister
    .desc = A canister filled with chlorine trifluoride (ClF3). Handle with extreme care.
...
ent-FrezonCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-MethaneCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-HydrogenCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-FluorineCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-ChlorineCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-ChlorineTrifluorideCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
