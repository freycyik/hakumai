...
ent-ComputerGridControl = grid control computer
    .desc = Used to prevent a grid from being unclaimed.
ent-ComputerMessageBoard = Message Board Console
    .desc = Used to communicate across the Sector.
ent-ComputerStationModification = faction modification computer
    .desc = Used to structure assignments and access.
ent-ComputerIdPrinter = ID printer computer
    .desc = Prints out replacement IDs.
ent-ComputerInvoicePrinter = Invoice printer computer
    .desc = Prints out payable invoices.
