...
ent-GridControlComputerCircuitboard = grid control computer board
    .desc = A computer printed circuit board for a grid control computer.
ent-MessageBoardCircuitboard = message board computer board
    .desc = A computer printed circuit board for a message board computer.
ent-StationModComputerCircuitboard = faction modification computer board
    .desc = A computer printed circuit board for a faction modification computer.
ent-IdPrinterCircuitboard = ID printer console board
    .desc = A computer printed circuit board for an ID printer console.
ent-InvoicePrinterCircuitboard = Invoice printer console board
    .desc = A computer printed circuit board for an Invoice printer console.
