...
ent-FoodBurgerLung = lung burger
    .desc = A strange looking burger.
ent-FoodBurgerLiver = liver burger
    .desc = A strange looking burger.
ent-FoodBurgerStomach = stomach burger
    .desc = A strange looking burger.
ent-FoodBurgerKidneys = kidneys burger
    .desc = A strange looking burger.
ent-FoodBurgerHeart = heart burger
    .desc = A strange looking burger.
