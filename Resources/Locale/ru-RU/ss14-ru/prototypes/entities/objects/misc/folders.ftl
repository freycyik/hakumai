...
ent-BoxFolderTitaniumBaseEmpty = reinforced folder
    .desc = A folder created out of a solid sheet of titanium. Features a sealing mechanism which holds it's contents safely inside. Durable, robust, and explosion resistant.
